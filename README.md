...
<p align="center">
  <a href="https://goreportcard.com/report/github.com/snowdence/mgm">
    <img src="https://goreportcard.com/badge/github.com/snowdence/mgm">
  </a>
  <a href="https://godoc.org/github.com/snowdence/mgm">
    <img src="https://godoc.org/github.com/snowdence/mgm?status.svg" alt="GoDoc">
  </a>
...
```bash
go get github.com/snowdence/mgm/v3
```
...
import (
   "github.com/snowdence/mgm/v3"
   "github.com/snowdence/mgm/v3/builder"
   "github.com/snowdence/mgm/v3/field"
...
import (
   ...
   "github.com/snowdence/mgm/v3/builder"
   "github.com/snowdence/mgm/v3/field"
   "github.com/snowdence/mgm/v3/operator"
   . "go.mongodb.org/mongo-driver/bson"
   "go.mongodb.org/mongo-driver/bson/primitive"
)
...
import (
   "github.com/snowdence/mgm/v3"
   f "github.com/snowdence/mgm/v3/field"
   o "github.com/snowdence/mgm/v3/operator"
   "go.mongodb.org/mongo-driver/bson"
)
...
New features can be requested and bugs can be reported on [Github issue tracker](https://github.com/snowdence/mgm/issues).

## Communicate With Us

* Create new topic at [mongo-go-models Google Group](https://groups.google.com/forum/#!forum/mongo-go-models)  
* Ask your question or request new feature by creating an issue at [Github issue tracker](https://github.com/snowdence/mgm/issues)  

## Contributing 

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/snowdence/mgm)
...
Mongo Go Models is released under the [Apache License](https://github.com/snowdence/mgm/blob/master/LICENSE)
